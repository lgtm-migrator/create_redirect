...
The ``create_redirect`` source code is available on GitHub,
...
The recommended way to build ``create_redirect`` is to use `tox <https://tox.readthedocs.io/en/latest/>`_:
